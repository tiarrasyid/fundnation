                ...
                >
                  ...
                  <div className="p-[10px]">
                    ...
                    <div className="text-sm text-gray-700 mb-2 flex items-center">
                      <span className="mr-1">💰</span> ${project.totalRaised.toLocaleString()}
                    </div>
                    <div className="text-sm text-gray-700 mb-2 flex items-center">
                      <span className="mr-1">📅</span> {daysLeft} Days left
                    </div>
                    <p className="text-sm text-gray-600 italic mb-4">by {project.creator}</p>
